...
// { success: true, requires2FA: true, message: '...' } y envía el código
// por correo. Si requires2FA es false/ausente, ya viene la sesión iniciada.
export const login = (credentials) => api.post('/auth/login', credentials)

// Paso 2 del login (solo si el paso 1 devolvió requires2FA: true).
...
export const requestPasswordReset = ({ email }) =>
  api.post('/auth/recovery/request', { email })
